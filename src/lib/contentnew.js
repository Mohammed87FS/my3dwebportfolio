...
export  const Fortress = `<div class="content" style="font-size: 4.6rem; font-family: 'Press Start 2P', cursive; padding: 20px; margin-bottom: 20px; ">
